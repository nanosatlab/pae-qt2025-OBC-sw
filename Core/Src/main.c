...
SPI_HandleTypeDef hspi1; // important to define it because of extern declaration in header
...
int prova(void); //provisional
void prova_send(const char *msg); //provisional
...
int main(void)
{
    ...
    HAL_Init();
    SystemClock_Config();
    MX_USART3_UART_Init(); // Initialized for printf usage
