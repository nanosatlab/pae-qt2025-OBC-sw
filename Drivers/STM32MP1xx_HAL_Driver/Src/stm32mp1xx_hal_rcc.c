...
HAL_StatusTypeDef HAL_RCC_DeInit(void) {
	...
	CLEAR_BIT(RCC->PLL2CR,
			RCC_PLL2CR_DIVPEN | RCC_PLL2CR_DIVQEN | RCC_PLL2CR_DIVREN);
	...
	CLEAR_BIT(RCC->PLL3CR,
			RCC_PLL3CR_DIVPEN | RCC_PLL3CR_DIVQEN | RCC_PLL3CR_DIVREN);
	...
	CLEAR_BIT(RCC->PLL4CR,
			RCC_PLL4CR_DIVPEN | RCC_PLL4CR_DIVQEN | RCC_PLL4CR_DIVREN);
	...
	WRITE_REG(RCC->OCENCLRR,
			RCC_OCENCLRR_HSIKERON | RCC_OCENCLRR_CSION | RCC_OCENCLRR_CSIKERON | RCC_OCENCLRR_DIGBYP | RCC_OCENCLRR_HSEON | RCC_OCENCLRR_HSEKERON | RCC_OCENCLRR_HSEBYP);
...
#ifdef CORE_CM4
	/* Reset RCC Clock Source Interrupt Enable Register */
	CLEAR_BIT(RCC->MC_CIER,
			(RCC_MC_CIER_LSIRDYIE | RCC_MC_CIER_LSERDYIE | RCC_MC_CIER_HSIRDYIE | RCC_MC_CIER_HSERDYIE | RCC_MC_CIER_CSIRDYIE | RCC_MC_CIER_PLL1DYIE | RCC_MC_CIER_PLL2DYIE | RCC_MC_CIER_PLL3DYIE | RCC_MC_CIER_PLL4DYIE | RCC_MC_CIER_LSECSSIE | RCC_MC_CIER_WKUPIE));

	/* Clear all RCC MCU interrupt flags */
	SET_BIT(RCC->MC_CIFR,
			(RCC_MC_CIFR_LSIRDYF | RCC_MC_CIFR_LSERDYF | RCC_MC_CIFR_HSIRDYF | RCC_MC_CIFR_HSERDYF | RCC_MC_CIFR_CSIRDYF | RCC_MC_CIFR_PLL1DYF | RCC_MC_CIFR_PLL2DYF | RCC_MC_CIFR_PLL3DYF | RCC_MC_CIFR_PLL4DYF | RCC_MC_CIFR_LSECSSF | RCC_MC_CIFR_WKUPF));

	/* Clear all RCC MCU Reset Flags */
	SET_BIT(RCC->MC_RSTSCLRR,
			RCC_MC_RSTSCLRR_WWDG1RSTF | RCC_MC_RSTSCLRR_IWDG2RSTF | RCC_MC_RSTSCLRR_IWDG1RSTF | RCC_MC_RSTSCLRR_MCSYSRSTF | RCC_MC_RSTSCLRR_MPSYSRSTF | RCC_MC_RSTSCLRR_MCURSTF | RCC_MC_RSTSCLRR_VCORERSTF | RCC_MC_RSTSCLRR_HCSSRSTF | RCC_MC_RSTSCLRR_PADRSTF | RCC_MC_RSTSCLRR_BORRSTF | RCC_MC_RSTSCLRR_PORRSTF);
#endif
...
__weak HAL_StatusTypeDef HAL_RCC_OscConfig(
	...
	if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_HSI)
		...
		assert_param(
				IS_RCC_HSICALIBRATION_VALUE(RCC_OscInitStruct->HSICalibrationValue));
	...
	if (((RCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_CSI)
		...
		assert_param(
				IS_RCC_CSICALIBRATION_VALUE(RCC_OscInitStruct->CSICalibrationValue));
		...
		if (!__IS_PLL1_IN_USE()) /* If not used then */
		{
			if ((pll1->PLLState) == RCC_PLL_ON) {
				...
				__HAL_RCC_PLL1CLKOUT_DISABLE(
						RCC_PLL1_DIVP | RCC_PLL1_DIVQ | RCC_PLL1_DIVR);
				...
				__HAL_RCC_PLL1_CONFIG(pll1->PLLM, pll1->PLLN, pll1->PLLP,
						pll1->PLLQ, pll1->PLLR);
				...
				if (pll1->PLLMODE == RCC_PLL_SPREAD_SPECTRUM) {
					...
					__HAL_RCC_PLL1CSGCONFIG(pll1->MOD_PER, pll1->TPDFN_DIS,
							pll1->RPDFN_DIS, pll1->SSCG_MODE, pll1->INC_STEP);
...
HAL_StatusTypeDef HAL_RCC_ClockConfig(RCC_ClkInitTypeDef *RCC_ClkInitStruct) {
	...
	if ((RCC_ClkInitStruct->ClockType & RCC_CLOCKTYPE_ACLK)
			== RCC_CLOCKTYPE_ACLK) {
	...
	if ((RCC_ClkInitStruct->ClockType & RCC_CLOCKTYPE_PCLK4)
			== RCC_CLOCKTYPE_PCLK4) {
	...
	if ((RCC_ClkInitStruct->ClockType & RCC_CLOCKTYPE_PCLK5)
			== RCC_CLOCKTYPE_PCLK5) {
	...
	if ((RCC_ClkInitStruct->ClockType & RCC_CLOCKTYPE_PCLK3)
			== RCC_CLOCKTYPE_PCLK3) {
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef *RCC_OscInitStruct) {
	...
	RCC_OscInitStruct->CSICalibrationValue = (uint32_t) ((RCC->CSICFGR
	...
	RCC_OscInitStruct->HSICalibrationValue = (uint32_t) ((RCC->HSICFGR
	...
	RCC_OscInitStruct->PLL.PLLSource = (uint32_t) (RCC->RCK12SELR
			& RCC_RCK12SELR_PLL12SRC);
	RCC_OscInitStruct->PLL.PLLM = (uint32_t) ((RCC->PLL1CFGR1
			& RCC_PLL1CFGR1_DIVM1) >> RCC_PLL1CFGR1_DIVM1_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLN = (uint32_t) ((RCC->PLL1CFGR1
			& RCC_PLL1CFGR1_DIVN) >> RCC_PLL1CFGR1_DIVN_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLR = (uint32_t) ((RCC->PLL1CFGR2
			& RCC_PLL1CFGR2_DIVR) >> RCC_PLL1CFGR2_DIVR_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLP = (uint32_t) ((RCC->PLL1CFGR2
			& RCC_PLL1CFGR2_DIVP) >> RCC_PLL1CFGR2_DIVP_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLQ = (uint32_t) ((RCC->PLL1CFGR2
			& RCC_PLL1CFGR2_DIVQ) >> RCC_PLL1CFGR2_DIVQ_Pos) + 1;
	RCC_OscInitStruct->PLL.PLLFRACV = (uint32_t) ((RCC->PLL1FRACR
			& RCC_PLL1FRACR_FRACV) >> RCC_PLL1FRACR_FRACV_Pos);
	...
	RCC_OscInitStruct->PLL.MOD_PER = (uint32_t) (RCC->PLL1CSGR
			& RCC_PLL1CSGR_MOD_PER);
	RCC_OscInitStruct->PLL.TPDFN_DIS = (uint32_t) (RCC->PLL1CSGR
			& RCC_PLL1CSGR_TPDFN_DIS);
	RCC_OscInitStruct->PLL.RPDFN_DIS = (uint32_t) (RCC->PLL1CSGR
			& RCC_PLL1CSGR_RPDFN_DIS);
	RCC_OscInitStruct->PLL.SSCG_MODE = (uint32_t) (RCC->PLL1CSGR
			& RCC_PLL1CSGR_SSCG_MODE);
	RCC_OscInitStruct->PLL.INC_STEP = (uint32_t) ((RCC->PLL1CSGR
			& RCC_PLL1CSGR_INC_STEP) >> RCC_PLL1CSGR_INC_STEP_Pos);
	...
	RCC_OscInitStruct->PLL2.PLLSource = (uint32_t) (RCC->RCK12SELR
			& RCC_RCK12SELR_PLL12SRC);
	RCC_OscInitStruct->PLL2.PLLM = (uint32_t) ((RCC->PLL2CFGR1
			& RCC_PLL2CFGR1_DIVM2) >> RCC_PLL2CFGR1_DIVM2_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLN = (uint32_t) ((RCC->PLL2CFGR1
			& RCC_PLL2CFGR1_DIVN) >> RCC_PLL2CFGR1_DIVN_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLR = (uint32_t) ((RCC->PLL2CFGR2
			& RCC_PLL2CFGR2_DIVR) >> RCC_PLL2CFGR2_DIVR_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLP = (uint32_t) ((RCC->PLL2CFGR2
			& RCC_PLL2CFGR2_DIVP) >> RCC_PLL2CFGR2_DIVP_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLQ = (uint32_t) ((RCC->PLL2CFGR2
			& RCC_PLL2CFGR2_DIVQ) >> RCC_PLL2CFGR2_DIVQ_Pos) + 1;
	RCC_OscInitStruct->PLL2.PLLFRACV = (uint32_t) ((RCC->PLL2FRACR
			& RCC_PLL2FRACR_FRACV) >> RCC_PLL2FRACR_FRACV_Pos);
	...
	RCC_OscInitStruct->PLL2.MOD_PER = (uint32_t) (RCC->PLL2CSGR
			& RCC_PLL2CSGR_MOD_PER);
	RCC_OscInitStruct->PLL2.TPDFN_DIS = (uint32_t) (RCC->PLL2CSGR
			& RCC_PLL2CSGR_TPDFN_DIS);
	RCC_OscInitStruct->PLL2.RPDFN_DIS = (uint32_t) (RCC->PLL2CSGR
			& RCC_PLL2CSGR_RPDFN_DIS);
	RCC_OscInitStruct->PLL2.SSCG_MODE = (uint32_t) (RCC->PLL2CSGR
			& RCC_PLL2CSGR_SSCG_MODE);
	RCC_OscInitStruct->PLL2.INC_STEP = (uint32_t) ((RCC->PLL2CSGR
			& RCC_PLL2CSGR_INC_STEP) >> RCC_PLL2CSGR_INC_STEP_Pos);
	...
	RCC_OscInitStruct->PLL3.PLLSource = (uint32_t) (RCC->RCK3SELR
			& RCC_RCK3SELR_PLL3SRC);
	RCC_OscInitStruct->PLL3.PLLM = (uint32_t) ((RCC->PLL3CFGR1
			& RCC_PLL3CFGR1_DIVM3) >> RCC_PLL3CFGR1_DIVM3_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLN = (uint32_t) ((RCC->PLL3CFGR1
			& RCC_PLL3CFGR1_DIVN) >> RCC_PLL3CFGR1_DIVN_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLR = (uint32_t) ((RCC->PLL3CFGR2
			& RCC_PLL3CFGR2_DIVR) >> RCC_PLL3CFGR2_DIVR_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLP = (uint32_t) ((RCC->PLL3CFGR2
			& RCC_PLL3CFGR2_DIVP) >> RCC_PLL3CFGR2_DIVP_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLQ = (uint32_t) ((RCC->PLL3CFGR2
			& RCC_PLL3CFGR2_DIVQ) >> RCC_PLL3CFGR2_DIVQ_Pos) + 1;
	RCC_OscInitStruct->PLL3.PLLRGE = (uint32_t) (RCC->PLL3CFGR1
			& RCC_PLL3CFGR1_IFRGE);
	RCC_OscInitStruct->PLL3.PLLFRACV = (uint32_t) ((RCC->PLL3FRACR
			& RCC_PLL3FRACR_FRACV) >> RCC_PLL3FRACR_FRACV_Pos);
	...
	RCC_OscInitStruct->PLL3.MOD_PER = (uint32_t) (RCC->PLL3CSGR
			& RCC_PLL3CSGR_MOD_PER);
	RCC_OscInitStruct->PLL3.TPDFN_DIS = (uint32_t) (RCC->PLL3CSGR
			& RCC_PLL3CSGR_TPDFN_DIS);
	RCC_OscInitStruct->PLL3.RPDFN_DIS = (uint32_t) (RCC->PLL3CSGR
			& RCC_PLL3CSGR_RPDFN_DIS);
	RCC_OscInitStruct->PLL3.SSCG_MODE = (uint32_t) (RCC->PLL3CSGR
			& RCC_PLL3CSGR_SSCG_MODE);
	RCC_OscInitStruct->PLL3.INC_STEP = (uint32_t) ((RCC->PLL3CSGR
			& RCC_PLL3CSGR_INC_STEP) >> RCC_PLL3CSGR_INC_STEP_Pos);
	...
	RCC_OscInitStruct->PLL4.PLLSource = (uint32_t) (RCC->RCK4SELR
			& RCC_RCK4SELR_PLL4SRC);
	RCC_OscInitStruct->PLL4.PLLM = (uint32_t) ((RCC->PLL4CFGR1
			& RCC_PLL4CFGR1_DIVM4) >> RCC_PLL4CFGR1_DIVM4_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLN = (uint32_t) ((RCC->PLL4CFGR1
			& RCC_PLL4CFGR1_DIVN) >> RCC_PLL4CFGR1_DIVN_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLR = (uint32_t) ((RCC->PLL4CFGR2
			& RCC_PLL4CFGR2_DIVR) >> RCC_PLL4CFGR2_DIVR_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLP = (uint32_t) ((RCC->PLL4CFGR2
			& RCC_PLL4CFGR2_DIVP) >> RCC_PLL4CFGR2_DIVP_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLQ = (uint32_t) ((RCC->PLL4CFGR2
			& RCC_PLL4CFGR2_DIVQ) >> RCC_PLL4CFGR2_DIVQ_Pos) + 1;
	RCC_OscInitStruct->PLL4.PLLRGE = (uint32_t) (RCC->PLL4CFGR1
			& RCC_PLL4CFGR1_IFRGE);
	RCC_OscInitStruct->PLL4.PLLFRACV = (uint32_t) ((RCC->PLL4FRACR
			& RCC_PLL4FRACR_FRACV) >> RCC_PLL4FRACR_FRACV_Pos);
	...
	RCC_OscInitStruct->PLL4.MOD_PER = (uint32_t) (RCC->PLL4CSGR
			& RCC_PLL4CSGR_MOD_PER);
	RCC_OscInitStruct->PLL4.TPDFN_DIS = (uint32_t) (RCC->PLL4CSGR
			& RCC_PLL4CSGR_TPDFN_DIS);
	RCC_OscInitStruct->PLL4.RPDFN_DIS = (uint32_t) (RCC->PLL4CSGR
			& RCC_PLL4CSGR_RPDFN_DIS);
	RCC_OscInitStruct->PLL4.SSCG_MODE = (uint32_t) (RCC->PLL4CSGR
			& RCC_PLL4CSGR_SSCG_MODE);
	RCC_OscInitStruct->PLL4.INC_STEP = (uint32_t) ((RCC->PLL4CSGR
			& RCC_PLL4CSGR_INC_STEP) >> RCC_PLL4CSGR_INC_STEP_Pos);
...
void HAL_RCC_GetClockConfig(RCC_ClkInitTypeDef *RCC_ClkInitStruct,
	...
	RCC_ClkInitStruct->ClockType = RCC_CLOCKTYPE_MPU | RCC_CLOCKTYPE_ACLK
			...
			RCC_CLOCKTYPE_PCLK5 | RCC_CLOCKTYPE_PCLK1 | RCC_CLOCKTYPE_PCLK2
			| RCC_CLOCKTYPE_PCLK3;
...
__weak void HAL_RCC_GetPLL1ClockFreq(PLL1_ClocksTypeDef *PLL1_Clocks) {
	...
	pll1m = ((RCC->PLL1CFGR1 & RCC_PLL1CFGR1_DIVM1) >> RCC_PLL1CFGR1_DIVM1_Pos)
			+ 1U;
	pll1fracen = (RCC->PLL1FRACR & RCC_PLL1FRACR_FRACLE)
			>> RCC_PLL1FRACR_FRACLE_Pos;
	fracn1 =
			(float) (pll1fracen
					* ((RCC->PLL1FRACR & RCC_PLL1FRACR_FRACV)
							>> RCC_PLL1FRACR_FRACV_Pos));
	pll1vco = (float) ((float) ((RCC->PLL1CFGR1 & RCC_PLL1CFGR1_DIVN) + 1U)
	...
	PLL1_Clocks->PLL1_P_Frequency = (uint32_t) (pll1vco
			/ ((float) (((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVP)
					>> RCC_PLL1CFGR2_DIVP_Pos) + 1U)));
	PLL1_Clocks->PLL1_Q_Frequency = (uint32_t) (pll1vco
			/ ((float) (((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVQ)
					>> RCC_PLL1CFGR2_DIVQ_Pos) + 1U)));
	PLL1_Clocks->PLL1_R_Frequency = (uint32_t) (pll1vco
			/ ((float) (((RCC->PLL1CFGR2 & RCC_PLL1CFGR2_DIVR)
					>> RCC_PLL1CFGR2_DIVR_Pos) + 1U)));
}
...
__weak void HAL_RCC_GetPLL2ClockFreq(PLL2_ClocksTypeDef *PLL2_Clocks) {
	...
	pllsource = __HAL_RCC_GET_PLL12_SOURCE();
	pll2m = ((RCC->PLL2CFGR1 & RCC_PLL2CFGR1_DIVM2) >> RCC_PLL2CFGR1_DIVM2_Pos)
			+ 1U;
	pll2fracen = (RCC->PLL2FRACR & RCC_PLL2FRACR_FRACLE)
			>> RCC_PLL2FRACR_FRACLE_Pos;
	fracn1 =
			(float) (pll2fracen
					* ((RCC->PLL2FRACR & RCC_PLL2FRACR_FRACV)
							>> RCC_PLL2FRACR_FRACV_Pos));
	pll2vco = (float) ((float) ((RCC->PLL2CFGR1 & RCC_PLL2CFGR1_DIVN) + 1U)
			+ (fracn1 / (float) 0x2000));  //Intermediary value
	switch (pllsource) {
	case RCC_PLL12SOURCE_HSI: /* HSI used as PLL clock source */
		if (__HAL_RCC_GET_FLAG(RCC_FLAG_HSIDIVRDY) != 0U) {
	...
	PLL2_Clocks->PLL2_P_Frequency = (uint32_t) (pll2vco
			/ ((float) (((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVP)
					>> RCC_PLL2CFGR2_DIVP_Pos) + 1U)));
	PLL2_Clocks->PLL2_Q_Frequency = (uint32_t) (pll2vco
			/ ((float) (((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVQ)
					>> RCC_PLL2CFGR2_DIVQ_Pos) + 1U)));
	PLL2_Clocks->PLL2_R_Frequency = (uint32_t) (pll2vco
			/ ((float) (((RCC->PLL2CFGR2 & RCC_PLL2CFGR2_DIVR)
...
__weak void HAL_RCC_GetPLL3ClockFreq(PLL3_ClocksTypeDef *PLL3_Clocks) {
	...
	PLL3_Clocks->PLL3_P_Frequency = (uint32_t) (pll3vco
			/ ((float) (((RCC->PLL3CFGR2 & RCC_PLL3CFGR2_DIVP)
					>> RCC_PLL3CFGR2_DIVP_Pos) + 1U)));
	PLL3_Clocks->PLL3_Q_Frequency = (uint32_t) (pll3vco
			/ ((float) (((RCC->PLL3CFGR2 & RCC_PLL3CFGR2_DIVQ)
					>> RCC_PLL3CFGR2_DIVQ_Pos) + 1U)));
	PLL3_Clocks->PLL3_R_Frequency = (uint32_t) (pll3vco
			/ ((float) (((RCC->PLL3CFGR2 & RCC_PLL3CFGR2_DIVR)
...
__weak void HAL_RCC_GetPLL4ClockFreq(PLL4_ClocksTypeDef *PLL4_Clocks) {
	...
	pll4m = ((RCC->PLL4CFGR1 & RCC_PLL4CFGR1_DIVM4) >> RCC_PLL4CFGR1_DIVM4_Pos)
			+ 1U;
	pll4fracen = (RCC->PLL4FRACR & RCC_PLL4FRACR_FRACLE)
			>> RCC_PLL4FRACR_FRACLE_Pos;
	fracn1 =
			(float) (pll4fracen
					* ((RCC->PLL4FRACR & RCC_PLL4FRACR_FRACV)
							>> RCC_PLL4FRACR_FRACV_Pos));
	pll4vco = (float) ((float) ((RCC->PLL4CFGR1 & RCC_PLL4CFGR1_DIVN) + 1U)
			+ (fracn1 / (float) 0x2000));  //Intermediary value
	switch (pllsource) {
	...
	PLL4_Clocks->PLL4_P_Frequency = (uint32_t) (pll4vco
			/ ((float) (((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVP)
					>> RCC_PLL4CFGR2_DIVP_Pos) + 1U)));
	PLL4_Clocks->PLL4_Q_Frequency = (uint32_t) (pll4vco
			/ ((float) (((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVQ)
					>> RCC_PLL4CFGR2_DIVQ_Pos) + 1U)));
	PLL4_Clocks->PLL4_R_Frequency = (uint32_t) (pll4vco
			/ ((float) (((RCC->PLL4CFGR2 & RCC_PLL4CFGR2_DIVR)
					>> RCC_PLL4CFGR2_DIVR_Pos) + 1U)));
}
